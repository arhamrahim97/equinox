...
return [
    ...
    'upload_surat_tugas' => '<i class="fas fa-upload"></i> Upload the Letter of Assignment',    
    'download_surat_tugas' => '<i class="fas fa-download"></i> Download Letter of Assignment',
