...
<head>
    ...
    <!-- favicon icon -->
    <link rel="shortcut icon" href="{{asset('assets/landing_page')}}/images/favicon.png">
    <link rel="apple-touch-icon" href="{{asset('assets/landing_page')}}/images/apple-touch-icon-57x57.png">
    <link rel="apple-touch-icon" sizes="72x72"
        href="{{asset('assets/landing_page')}}/images/apple-touch-icon-72x72.png">
    <link rel="apple-touch-icon" sizes="114x114"
        href="{{asset('assets/landing_page')}}/images/apple-touch-icon-114x114.png">
