        ...
        <div class="row align-items-stretch justify-content-center extra-small-screen">
            <div
                ...
                <h2
                    ...
                    {{__('pages/landing/moa.daftar_moa')}}</h2>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-5">
                <select class="small-input bg-white margin-20px-bottom filterBerkas" id="region" name="kategori"
                    ...
                    <option hidden selected value="">{{__('pages/landing/moa.pilih_region')}}</option>
                    <option value="">{{__('pages/landing/moa.semua')}}</option>
            ...
            <div class="col-lg-2">
                <select class="small-input bg-white margin-20px-bottom filterBerkas" id="status">
                    <option hidden selected value="">{{__('pages/landing/moa.pilih_status')}}</option>
                    <option value="">{{__('pages/landing/moa.semua')}}</option>
                    <option value="Aktif">{{__('pages/landing/moa.aktif')}}</option>
                    <option value="Masa Tenggang">{{__('pages/landing/moa.masa_tenggang')}}</option>
                    <option value="Kadaluarsa">{{__('pages/landing/moa.kadaluarsa')}}</option>
                </select>
            </div>
        </div>
    </div>
