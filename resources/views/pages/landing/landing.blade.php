                    ...
                    <ul>
                        ...
                        <li data-index="rs-73" data-transition="fade" data-slotamount="default" data-hideafterloop="0"
                            ...
                            @if (!Auth::user())
                                <a class="tp-caption tp-resizeme btn btn-medium btn-white btn-box-shadow lg-margin-15px-bottom md-no-margin-bottom md-margin-auto-lr fw-bold"
                                    ...
                                    data-paddingtop="[11,10,10,10]" data-paddingright="[27,25,25,22]"
                                    data-paddingbottom="[11,10,10,10]" data-paddingleft="[27,25,25,22]"
                            ...
                            <div class="tp-caption tp-resizeme rs-parallaxlevel-2"
                                ...
                                data-textAlign="['inherit','inherit','inherit','inherit']" data-paddingtop="[0,0,0,0]"
                                data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]"
                                style="z-index: 6;"><img src="{{ Storage::url('upload/slider/' . $slider[0]->foto) }}"
                                    alt="" data-ww="['800px','420px','420px','290px']"
                                    data-hh="['auto','auto','auto','auto']" width="1000" height="1000" data-no-retina>
                            </div>
                        ...
                        <li data-index="rs-74" data-transition="fade" data-slotamount="default" data-hideafterloop="0"
                            ...
                            <div class="tp-caption tp-resizeme alt-font text-extra-dark-gray font-weight-500"
                                ...
                                data-voffset="['-185','-120','-410','-300']" data-width="none" data-height="none"
                            ...
                            <div class="tp-caption alt-font text-extra-dark-gray"
                                ...
                                data-width="auto" data-height="none" data-whitespace="nowrap" data-type="text"
                            ...
                            <div class="tp-caption tp-resizeme rs-parallaxlevel-2"
                                ...
                                data-textAlign="['inherit','inherit','inherit','inherit']" data-paddingtop="[0,0,0,0]"
                                data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]"
                                style="z-index: 6;"><img src="{{ Storage::url('upload/slider/' . $slider[1]->foto) }}"
                                    alt="" data-ww="['800px','420px','420px','290px']"
                                    data-hh="['auto','auto','auto','auto']" width="1000" height="1000" data-no-retina>
                            </div>
                        ...
                        <li data-index="rs-75" data-transition="fade" data-slotamount="default" data-hideafterloop="0"
                            ...
                            <div class="tp-caption tp-resizeme rs-parallaxlevel-2"
                                ...
                                data-textAlign="['inherit','inherit','inherit','inherit']" data-paddingtop="[0,0,0,0]"
                                data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]"
                                style="z-index: 6;"><img src="{{ Storage::url('upload/slider/' . $slider[2]->foto) }}"
                                    alt="" data-ww="['800px','420px','420px','290px']"
                                    data-hh="['auto','auto','auto','auto']" width="1000" height="1000" data-no-retina>
                            </div>
                        ...
                        <li data-index="rs-76" data-transition="fade" data-slotamount="default" data-hideafterloop="0"
                            ...
                            <div class="tp-caption tp-resizeme alt-font text-extra-dark-gray font-weight-500"
                                ...
                                data-paddingright="[20,20,20,20]" data-paddingbottom="[10,10,10,10]"
                                data-paddingleft="[20,20,20,20]"
                                style="z-index: 7; text-transform: uppercase; letter-spacing: 2px;">Implementation
                                Agreement
                            </div>
                            ...
                            <div class="tp-caption tp-resizeme rs-parallaxlevel-2"
                                ...
                                data-textAlign="['inherit','inherit','inherit','inherit']" data-paddingtop="[0,0,0,0]"
                                data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]"
                                style="z-index: 6;"><img src="{{ Storage::url('upload/slider/' . $slider[3]->foto) }}"
                                    alt="" data-ww="['800px','420px','420px','290px']"
                                    data-hh="['auto','auto','auto','auto']" width="1000" height="1000" data-no-retina>
                            </div>
                        ...
                        <div class="tp-caption tp-resizeme text-white rs-parallaxlevel-1 alt-font text-extra-medium"
                            ...
                            data-fontsize="['16','16','16','15']" data-width="['201','150','150','120']"
                            data-height="none" data-whitespace="['normal','nowrap','nowrap','nowrap']" data-type="text"
                            data-responsive_offset="on"
    ...
    <section class="border-top border-color-medium-gray">
        <div class="row justify-content-center">
            <div class="col-12 col-md-6 text-center margin-5-half-rem-bottom md-margin-3-rem-bottom wow animate__fadeIn">
                <span
                    class="alt-font font-weight-500 text-dark-orange text-uppercase letter-spacing-1px d-block margin-5px-bottom">{{ __('pages/landing/landing.statistik') }}</span>
                <h4 class="alt-font font-weight-600 text-extra-dark-gray mb-0 letter-spacing-minus-1px">
                    {{ __('pages/landing/landing.mou_dan_ia') }}</h4>
            </div>
        ...
        <div class="row justify-content-center mt-5">
            <div class="col-12 col-md-6 text-center margin-5-half-rem-bottom md-margin-3-rem-bottom wow animate__fadeIn">
                <a href="{{ url('/detailIa') }}"
                    class="btn btn-fancy btn-medium btn-dark-gray margin-20px-top section-link">{{ __('pages/landing/landing.detail_ia') }}</a>
            </div>
        </div>
    </section>
    <!-- end section -->
                            ...
                            @foreach ($daftarBerita as $berita)
                                <li class="grid-item wow animate__fadeIn">
                                    <div class="blog-post border-radius-5px bg-white box-shadow-medium">
                                        ...
                                        <div
                                            class="post-details padding-3-rem-lr padding-2-half-rem-tb last-paragraph-no-margin">
...
@push('script')
                        ...
                        for (var i = 0; i < data[0].length; i++) {
                            ...
                            L.marker([data[0][i].latitude, data[0][i].longitude], {
                                ...
                                .bindPopup("<p class='fw-bold my-0 text-center title'>" + data[0][i]
                                    .nama_pengusul + "</p><hr>" +
                                    "<p class='my-0'>{{ __('pages/mou/map.program') }} " + data[0][i].program +
                                    "</p>" +
                                    "<p class='my-0'>{{ __('pages/mou/map.negara') }} " + data[0][i].negara +
                                    "</p>" +
                                    "<p class='my-0'>{{ __('pages/mou/map.alamat') }} " + data[0][i].alamat +
                                    "</p>" +
                                    "<p class='my-0'>{{ __('pages/mou/map.tanggal_berakhir') }} " + data[0][i]
                                    .tanggal_berakhir + "</p>" +
                                    "<p class='my-0'>{{ __('pages/mou/map.status') }} " + data[0][i]
                                    .namaStatus + "</p>"
                    ...
                    success: function(data) {
                        for (var i = 0; i < data[0].length; i++) {
                            ...
                            L.marker([data[0][i].latitude, data[0][i].longitude], {
                                ...
                                .bindPopup("<p class='fw-bold my-0 text-center title'>" + data[0][i]
                                    .nama_pengusul + "</p><hr>" +
                                    "<p class='my-0'>{{ __('pages/moa/map.program') }} " + data[0][i].program +
                                    "</p>" +
                                    "<p class='my-0'>{{ __('pages/moa/map.negara') }} " + data[0][i].negara +
                                    "</p>" +
                                    "<p class='my-0'>{{ __('pages/moa/map.alamat') }} " + data[0][i].alamat +
                                    "</p>" +
                                    "<p class='my-0'>{{ __('pages/moa/map.tanggal_berakhir') }} " + data[0][i]
                                    .tanggal_berakhir + "</p>" +
                                    "<p class='my-0'>{{ __('pages/moa/map.status') }} " + data[0][i]
                                    .namaStatus + "</p>"
                                ).on('click', L.bind(petaKlik, null, data[0][i].id)).addTo(map);
                        }
                    },
                    ...
                    success: function(data) {
                        for (var i = 0; i < data[0].length; i++) {
                            ...
                            L.marker([data[0][i].latitude, data[0][i].longitude], {
                                ...
                                "<p class='my-0'>{{ __('pages/ia/map.program') }} " + data[0][i].program +
                                "</p>" +
                                "<p class='my-0'>{{ __('pages/ia/map.negara') }} " + data[0][i].negara +
                                "</p>" +
                                "<p class='my-0'>{{ __('pages/ia/map.alamat') }} " + data[0][i].alamat +
                                "</p>" +
                                "<p class='my-0'>{{ __('pages/ia/map.tanggal_berakhir') }} " + data[0][i]
                                .tanggal_berakhir + "</p>" +
                                "<p class='my-0'>{{ __('pages/ia/map.status') }} " + data[0][i]
                                .namaStatus + "</p>"
                            ).on('click', L.bind(petaKlik, null, data[0][i].id)).addTo(map);
                        }
                    },
    ...
    <script>
        const labels = {!! json_encode($statistik['label']) !!};
        ...
        const data = {
            ...
            datasets: [{
                ...
                data: {!! json_encode($statistik['dataMoa']) !!},
            }, {
                label: 'IA',
                backgroundColor: 'rgb( 8, 120, 254 )',
                borderColor: 'rgb( 8, 120, 254 )',
                data: {!! json_encode($statistik['dataIa']) !!},
            }]
        };
