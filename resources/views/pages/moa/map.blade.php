        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <div class="card-title">{{__('pages/moa/map.titleCard')}}
                    </div>
                    <div class="card-category">{{__('pages/moa/map.subTitleCard')}}</div>
                </div>
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-lg-4" id="informasiMap" hidden>
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="fw-bold mb-0 card-text">{{__('pages/moa/map.nomor_moa')}} </p>
                                    <p class="card-text" id="nomor_moa">-</p>
                                    <hr class="card-text">

                                    <p class="fw-bold mb-0 card-text">{{__('pages/moa/map.nomor_moa_pengusul')}} </p>
                                    <p class="card-text" id="nomor_moa_pengusul">-</p>
                                    <hr class="card-text">

                                    <p class="fw-bold mb-0 card-text">{{__('pages/moa/map.nomor_mou')}} </p>
                                    <p class="card-text" id="nomor_mou">-</p>
                                    <hr class="card-text">

                                    <p class="fw-bold mb-0 card-text">{{__('pages/moa/map.nomor_mou_pengusul')}} </p>
                                    <p class="card-text" id="nomor_mou_pengusul">-</p>
                                    <hr class="card-text">

                                    <p class="fw-bold mb-0 card-text">{{__('pages/moa/map.nik')}}</p>
                                    <p class="card-text" id="nik_nip_pengusul">-</p>
                                    <hr class="card-text">

                                    <p class="fw-bold mb-0 card-text">{{__('pages/moa/map.jabatan')}}</p>
                                    <p class="card-text" id="jabatan">-</p>
                                    <hr class="card-text">

                                    <p class="fw-bold mb-0 card-text">{{__('pages/moa/map.alamat')}}</p>
                                    <p class="card-text" id="alamat">-</p>
                                    <hr class="card-text">

                                    <p class="fw-bold mb-0 card-text">{{__('pages/moa/map.tanggal_mulai')}}</p>
                                    <p class="card-text" id="tanggal_mulai">-</p>
                                    <hr class="card-text">

                                    <p class="fw-bold mb-0 card-text">{{__('pages/moa/map.tanggal_berakhir')}}</p>
                                    <p class="card-text" id="tanggal_berakhir">-</p>
                                    <hr class="card-text">

                                    <p class="fw-bold mb-0 card-text">{{__('pages/moa/map.pertemuan')}}</p>
                                    <p class="card-text" id="pertemuan">-</p>
                                    <hr class="card-text">

                                    <p class="fw-bold mb-0 card-text">{{__('pages/moa/map.status')}}</p>
