...
@push('style')
    <link rel="stylesheet"
        href="{{ asset('assets/dashboard/datatables/DataTables-1.10.16/css/dataTables.bootstrap4.min.css') }}">
    <link rel="stylesheet"
        href="{{ asset('assets/dashboard/datatables/Responsive-2.2.1/css/responsive.bootstrap4.min.css') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="selectgroup selectgroup-secondary selectgroup-pills">
                                        <label class="selectgroup-item">
                                            <input type="radio" name="jenis_dokumen" value="mou"
                                                class="selectgroup-input jenis_dokumen" checked>
                                            <span class="selectgroup-button selectgroup-button-icon"> MOU </span>
                                        </label>
                                        <label class="selectgroup-item">
                                            <input type="radio" name="jenis_dokumen" value="moa"
                                                class="selectgroup-input jenis_dokumen">
                                            <span class="selectgroup-button selectgroup-button-icon"> MOA </span>
                                        </label>
                                        <label class="selectgroup-item">
                                            <input type="radio" name="jenis_dokumen" value="ia"
                                                class="selectgroup-input jenis_dokumen">
                                    ...
                                    <div class="selectgroup selectgroup-pills">
                                        <label class="selectgroup-item">
                                            <input type="checkbox" name="status[]" value="aktif"
                                                class="selectgroup-input status1" checked>
                                            <span class="selectgroup-button">{{ __('components/span.aktif') }}</span>
                                        </label>
                                        <div class="d-none" id="tipe_change_mou_moa">
                                            <label class="selectgroup-item">
                                                <input type="checkbox" name="status[]" value="masa_tenggang"
                                                    class="selectgroup-input status2" checked>
                                                <span
                                                    class="selectgroup-button">{{ __('components/span.masa_tenggang') }}</span>
                                            </label>
                                            <label class="selectgroup-item">
                                                <input type="checkbox" name="status[]" value="kadaluarsa"
                                                    class="selectgroup-input status3" checked>
                                                <span
                                                    class="selectgroup-button">{{ __('components/span.kadaluarsa') }}</span>
                                            </label>
                                        </div>
                                        <div class="d-none" id="tipe_change_ia">
                                            <label class="selectgroup-item">
                                                <input type="checkbox" name="status[]" value="melewati_batas"
                                                    class="selectgroup-input status4" checked>
                                                <span
                                                    class="selectgroup-button">{{ __('components/span.melewati_batas') }}</span>
                                            </label>
                                            <label class="selectgroup-item">
                                                <input type="checkbox" name="status[]" value="selesai"
                                                    class="selectgroup-input status5" checked>
                            ...
                            <div class="col-lg-3 col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="select2-input select2-warning">
                                        <select id="dibuat_oleh" name="dibuat_oleh[]" class="form-control select2"
                                            multiple="multiple">
                                        </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group form-show-validation row mt-0 pt-0 px-0">
                                        <label for="name" class="col-lg-1 col-md-1 col-sm-4 mt-sm-2 text-left mr-3"
                                            style="font-weight: normal">{{ __('pages/master/rekapitulasi.mulai') }}
                                        </label>
                                        <div class="col-lg-4 col-md-9 col-sm-8 mb-1">
                                            <input name="dari_tanggal" id="dari_tanggal" type="text"
                                        ...
                                        <label for="name" class="col-lg-1 col-md-1 col-sm-4 mt-sm-2 text-left mr-4"
                                            style="font-weight: normal">{{ __('pages/master/rekapitulasi.sampai') }}
                                        </label>
                                        <div class="col-lg-4 col-md-9 col-sm-8">
                                            <input name="sampai_tanggal" id="sampai_tanggal" type="text"
                                                class="form-control tanggal">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div id="tabel-mou" class="row d-none">
                        <table id="dt-mou"
                            class="table table-bordered table-sm table-striped dt-class table-responsive" cellspacing="0"
                            width="100%" style="font-family: sans-serif">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center">{{ __('pages/master/rekapitulasi.pejabat_penandatangan') }}
                                    </th>
