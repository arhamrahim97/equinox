...
@section('title-tab')
| {{__('pages/berita/kategoriBerita.title')}}
@endsection
...
@section('subTitle')
{{__('pages/berita/kategoriBerita.subTitle')}}
@endsection
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">{{__('pages/berita/kategoriBerita.modalTitleTambah')}}</h5>
            ...
            <div class="modal-body">
                <form id="form-tambah">
                    <div class="form-group">
                        <label for="nama">{{__('pages/berita/kategoriBerita.title')}}</label>
                        <input type="text" class="form-control" id="nama"
                            placeholder="{{__('pages/berita/kategoriBerita.placeHolderTambah')}}">
...
<div class="modal" tabindex="-1" role="dialog" id="modal-ubah">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">{{__('pages/berita/kategoriBerita.modalTitleUbah')}}</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
...
<script>
    var table = $('.yajra-datatable').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ route('kategoriBerita.index') }}",
        columns: [{
                data: 'DT_RowIndex',
                name: 'DT_RowIndex'
            },
