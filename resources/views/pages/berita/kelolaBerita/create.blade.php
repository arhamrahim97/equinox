                            ...
                            <div class="form-row">
                                <div class="col-lg-8">
                                    <div class="form-group col-md-12">
                                        ...
                                        <textarea class="my-editor form-control" id="konten" cols="30" rows="10" name="konten"></textarea>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group col-md-12">
                                        ...
                                        <div id='img_contain' class="d-flex justify-content-center"><img id="blah"
                                                align='middle' src="/assets/dashboard/img/empty.png" alt=""
                                                title='' width="350px" /></div>
                                        <div class="input-group mt-2">
                                            <div class="custom-file">
                                                ...
                                                <label class="custom-file-label"
                                                    for="inputGroupFile01">{{ __('pages/berita/kelolaBerita.tambahSampul') }}</label>
                                            </div>
                                        </div>
                                        <small id="emailHelp"
                                            class="form-text text-muted">{{ __('pages/berita/kelolaBerita.ukuranFoto') }}</small>
                                        <span class="text-danger error-text fotoSampul-error"></span>
                                    </div>
                                    <div class="form-group col-md-12">
                                        <label for="judul">{{ __('pages/berita/kelolaBerita.judul') }}</label>
                                        <input type="text" class="form-control" id="judul"
                                            placeholder="{{ __('pages/berita/kelolaBerita.placeholderJudul') }}"
                                            name="judul" onkeypress="countJudul()" onkeyup="countJudul()">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <textarea class="form-control" id="deskripsi" cols="30" rows="10" name="deskripsi"
                                            placeholder="{{ __('pages/berita/kelolaBerita.placeholderDeskripsi') }}" onkeyup="countDeskripsi()"
                                            onkeypress="countDeskripsi()"></textarea>
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <select class="form-control" id="kategori" name="kategori">
                                            ...
                                            @foreach ($daftarKategoriBerita as $kategoriBerita)
                                                <option value="{{ $kategoriBerita->id }}">{{ $kategoriBerita->nama }}
                                                </option>
                                            @endforeach
                                        </select>
