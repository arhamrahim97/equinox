                            ...
                            <div class="col-lg-4">
                                <div class="form-group col-md-12">
                                    ...
                                    <div id='img_contain' class="d-flex justify-content-center"><img id="blah"
                                            align='middle' src="/assets/dashboard/img/empty.png" alt="" title=''
                                            width="350px" /></div>
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" class="form-control" id="judul"
                                        ...
                                        onkeypress="countJudul()" onkeyup="countJudul()">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <textarea class="form-control" id="deskripsi" cols="30" rows="10" name="deskripsi"
                                        ...
                                        onkeyup="countDeskripsi()" onkeypress="countDeskripsi()"></textarea>
