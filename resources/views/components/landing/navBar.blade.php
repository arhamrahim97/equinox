            ...
            <div class="col-auto col-sm-6 col-lg-2 me-auto ps-lg-0">
                <a class="navbar-brand" href="{{url('/')}}">
                    <img src="{{asset('assets/landing_page')}}/images/logo-simou.png"
                        data-at2x="{{asset('assets/landing_page')}}/images/logo-simou.png" alt="" class="default-logo">
                    <img src="{{asset('assets/landing_page')}}/images/logo-simou.png"
                        data-at2x="{{asset('assets/landing_page')}}/images/logo-simou.png" alt="" class="alt-logo">
                    <img src="{{asset('assets/landing_page')}}/images/logo-simou.png"
                        data-at2x="{{asset('assets/landing_page')}}/images/logo-simou.png" class="mobile-logo" alt="">
                </a>
            </div>
            <div class="col-auto menu-order px-lg-0">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                    <ul class="navbar-nav alt-font">
                        ...
                        <li class="nav-item">
                            <a href="{{url('/daftarMou')}}" class="nav-link">{{__('pages/landing/landing.mou')}}</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{url('/daftarMoa')}}" class="nav-link">{{__('pages/landing/landing.moa')}}</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            ...
                            @else
                            <a href="{{url('/login')}}" class="nav-link">{{__('pages/landing/landing.masuk')}}</a>
                            @endif
                        </li>
                    </ul>
                </div>
