        ...
        <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="cover">
                                <div id="peta" style="position: relative;  pointer-events: none;">
                                    <div class="overlay"
                                        style="background: rgba(0, 0, 0, 0.3); cursor: not-allowed; position: absolute; top: 0; z-index: 500; width: 100%; height: 300px">
                                    </div>
                                </div>
                            </div>
                            <div class="row mt-3">
            ...
            <div class="col-lg-6">
                <div class="form-group">
                    ...
                    <input name="nomor_mou_pengusul" id="nomor_mou_pengusul" type="text" class="form-control"
                        value="{{$nomor_mou_pengusul}}">
            ...
            <div class="col-lg-12 col-md-12">
                <div class="form-group">
                    <label>{{__('components/form_mou_moa_ia.nomor_mou_pengusul')}} :</label>
                    <select id="nomor_mou_pengusul_select" name="nomor_mou_pengusul" id="nomor_mou_pengusul"
            ...
            <div class="col-lg-6 col-md-6">
                <div class="form-group">
                    ...
                    <input name="nomor_moa_pengusul" id="nomor_moa_pengusul" type="text" class="form-control"
                        value="{{$nomor_moa_pengusul}}">
            ...
            <div class="col-lg-6 col-md-12">
                <div class="form-group">
                    <label>{{__('components/form_mou_moa_ia.nomor_mou_pengusul')}} :</label>
                    <input name="nomor_mou_pengusul" id="nomor_mou_pengusul" type="text" class="form-control" disabled
                        value="{{$nomor_mou_pengusul}}">
                    <span class="text-danger error-text nomor_mou_pengusul-error"></span>
                </div>
            </div>
            ...
            <div class="col-lg-6 col-md-6">
                <div class="form-group">
                    ...
                    <input name="nomor_ia_pengusul" id="nomor_ia_pengusul" type="text" class="form-control"
                        value="{{$nomor_ia_pengusul}}">
            ...
            <div class="col-12">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="program" id="program" cols="30"
                                rows="2">{{$program}}</textarea>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <div class="form-group">
                            ...
                            <input name="tanggal_mulai" id="tanggal_mulai" type="text" class="form-control tanggal"
                                value="{{$tanggal_mulai}} ">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="form-group">
                            ...
                            <input name="tanggal_berakhir" id="tanggal_berakhir" type="text"
                                class="form-control tanggal" value="{{$tanggal_berakhir}}">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group">
                            <label for="exampleFormControlFile1">{{__('components/form_mou_moa_ia.dokumen')}} (.pdf)
                                :</label>
                            <input type="file" class="form-control form-control-file" id="dokumen" name="dokumen">
                            <span
                                class="text-warning error-text">{{__('components/form_mou_moa_ia.dokumen_ubah')}}</span>
                    ...
                    <div class="col">
                        <div class="form-group">
                            ...
                            <div class="select2-input select2-warning">
                                <select id="program_studi" name="program_studi[]" id="program_studi"
                ...
                <div class="row">
                    <div class="col @if (!in_array($users_id_role, array('Admin', 'LPPM')))
                                    d-none
                                @endif">
                        <div class="form-group">
                            <label>{{__('components/form_mou_moa_ia.fakultas')}} :</label>
                            <div class="select2-input select2-warning">
                                <select id="fakultas" name="fakultas[]" class="form-control select2"
                                    multiple="multiple">
                                    {{-- <option value="">{{__('components/form_mou_moa_ia.pilih_salah_satu')}}</option>
                                    --}}
                                    {{$fakultas_all}}
                    ...
                    <div class="col @if ($users_id_role == 'Prodi')
                                    d-none
                                @endif">
                        <div class="form-group">
                            <label>{{__('components/form_mou_moa_ia.program_studi')}} :</label>
                            <div class="select2-input select2-warning">
                                <select id="program_studi" name="program_studi[]" class="form-control select2"
                                    multiple="multiple">
                                    {{-- <option value="">{{__('components/form_mou_moa_ia.pilih_salah_satu')}}</option>
                                    {{$prodi_all}} --}}
                                </select>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="manfaat" id="manfaat" cols="30"
                                rows="2">{{$manfaat}}</textarea>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <div class="form-group">
                            ...
                            <div class="select2-input select2-warning">
                                <select id="jenis_kerjasama" name="jenis_kerjasama[]" class="form-control select2"
                                    multiple="multiple">
                                    ...
                                    <option value="Pengabdian Kepada Masyarakat">
                                        {{__('components/form_mou_moa_ia.pengabdian_kepada_masyarakat')}}</option>
                                </select>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <input name="pejabat_penandatangan" id="pejabat_penandatangan" type="text"
                                class="form-control" value="{{$pejabat_penandatangan}}">
                    ...
                    <div class="col-lg-12">
                        <div class="form-check">
                            ...
                            <label class="form-radio-label">
                                <input class="form-radio-input" type="radio" id="desktodesk" name="metode_pertemuan"
                                    value="Desk to Desk" @if ($metode_pertemuan=='Desk to Desk' ) checked @endif>
                                <span class="form-radio-sign">{{__('components/form_mou_moa_ia.desktodesk')}}</span>
                            </label>
                            <label class="form-radio-label ml-5">
                                <input class="form-radio-input" type="radio" id="ceremonial" name="metode_pertemuan"
                                    value="Ceremonial" @if ($metode_pertemuan=='Ceremonial' ) checked @endif>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <div class="form-group">
                            ...
                            <input name="tanggal_pertemuan" id="tanggal_pertemuan" type="text"
                                class="form-control tanggal" value="{{$tanggal_pertemuan}} ">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="form-group">
                            ...
                            <input name="waktu_pertemuan" id="waktu_pertemuan" type="text" class="form-control waktu"
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="tempat_pertemuan" id="tempat_pertemuan" cols="30"
                                rows="2">{{$tempat_pertemuan}}</textarea>
